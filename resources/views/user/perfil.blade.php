                        ...
                        <a href="/dashboard" style="margin-left: auto; display: block" class="btn-close"
                            ...
                            <div class="row">
                                <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom01" disabled value="{{ Auth::user()->USE_PRIMER_NOMBRE }}">
                                        <div class="invalid-feedback">
                                            campo obligatorio
                                          </div>
                                          <br>
                                          <label for="validationCustom01" class="form-label">Nombre De Usuario <b style="color: #ff0000">*</b></label>
                                        <input type="text" class="form-control" id="validationCustom01" disabled value="{{ Auth::user()->name }}">
                                        <div class="invalid-feedback">
                                            campo obligatorio
                                          </div>
                                          <br>
